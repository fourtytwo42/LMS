  ...
  return (
    <div className="w-full space-y-8 sm:space-y-10">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Course Catalog</h1>
      ...
      <div className="mb-6 sm:mb-8 space-y-4 sm:space-y-5">
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-end">
          <select
            ...
            className="px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors w-full sm:w-auto"
          >
